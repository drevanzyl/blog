...
::: concise
- Leading the data and analytics teams in the [University Health Services](https://www.med.uc.edu/uhs) COVID-19 outbreak response.  
- Helping with prioritization. 
- Serving and advising the research team. 
- Analyzing and reporting on operational data. 
- Ensuring data collected in REDCap gets exported in a meaningful way to support clinical decision making. 
- Building of a "dashboard"  in the R Studio programming environment to ensure the clinicians and management can quickly get data out of REDCap without having to rely on me. 
:::
