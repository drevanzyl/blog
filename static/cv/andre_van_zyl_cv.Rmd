...
::: concise
- Work in application development and configuration for US COVID-19 clients using the [CommCare platform](https://www.dimagi.com/commcare/).
- Quality assurance. 
...
::: concise
- Led the [University Health Services](https://www.med.uc.edu/uhs) data and analytics efforts in COVID-19 surveillance and outbreak response.
...
- Ensured that the mobile data collection application meets the research project's protocol specifications and operational needs.
...
- Ensured that the researchers are blinded. 
...
- Tested the ITSI eLearning platform and recommending product improvements. 
