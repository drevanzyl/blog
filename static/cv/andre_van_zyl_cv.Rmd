...
André is a public health data analytics professional with approximately ten years’ work experience in roles related to research, technology, analytics, public health, behavioral health, and education.  His current career interests revolve around digital analytics and data science, electronic data acquisition, epidemiology, and monitoring and evaluation. He is used to working in settings where the resources required to meet project objectives are limited. For the past two years, he has been responsible for monitoring and managing the data collection of a research project with 27 sites in three South African provinces.
...
::: concise
- Application development, quality assurance, and configuration for US COVID-19 clients using the [CommCare platform](https://www.dimagi.com/commcare/).
...
- Utilizing [Asana](https://asana.com/) for project communication and management.
:::
...
::: concise
- Lead the [University Health Services](https://www.med.uc.edu/uhs) data and analytics teams in COVID-19 surveillance and outbreak response.
- Utilizing Google Docs and Google Sheets for project communication and management.
- Aid in defining objectives and priorities. 
- Analyze and report on operational data.
- Export and transform REDCap data using the [RStudio](https://rstudio.com/) programming environment to ensure clinicians and administrators have timely access to actionable data.
- Advising on business continuity planning and expansion.
- Identifying and engaging with service providers who could assist with system improvements.
:::
...
::: concise
- Drafting of the data management section of the protocol.
...
- Ensuring that the mobile data collection application meets the research project's protocol specifications and operational needs.
- Questionnaire improvement and translation to CommCare.
...
- Refining the mobile data collection application based on feedback from the research team, the project manager, the coordinators, and the team working at the clinics.  
- Provision of local and remote technical and data collection support to 27 fieldworkers and three project coordinators. 
- Managing the data collection operations with the help of RStudio, the [CommCare Data Export Tool]( https://confluence.dimagi.com/display/commcarepublic/CommCare+Data+Export+Tool), [WhatsApp]( https://www.whatsapp.com/), and the on-the-ground help of the project manager.
- Ensure that researchers are blinded. 
- Generate detailed Microsoft Word reports in RStudio, highlighting outliers and inconsistencies in the data. 
- Programmatically clean data based on the feedback from the districts. 
- Programmatically generate neatly structured and labeled [STATA](https://www.stata.com/) data files from our research data stored on a local PostgreSQL server. 
:::
...
::: concise
- Utilizing Google Docs, Google Sheets, and software developers project management tools. 
...
- Advising the software development team on product improvements based on feedback from our clients.
:::
